...
const Modal: React.FC<ModalProps> = ({ open, onClose, type = "success", title, description }) => {
    if(!open) return null;
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#a4a1aa42] backdrop-blur-md bg-opacity-40 ">
      <div className="bg-white p-6 min-w-[500px] shadow-lg relative">
